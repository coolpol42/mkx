let backendUrl = "http://localhost/mkx/backend.php";
...
], function (Controller, MessageToast, MessageBox, List, StandardListItem) {
    "use strict";
    var that, minLength, inputs, oView;
    return Controller.extend("sap.ui.mkx.controller.App", {
        onInit: function () {
            that = this;
            minLength = this.getView().getModel("limits").getProperty("/minLength");
            oView = this.getView();
            inputs = [
